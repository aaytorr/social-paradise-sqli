					...
					<table width='100%'>
						<tr>
							<td valign='top'><center>
								<b>Item:</b>
								<div style='border: 1px solid #ddd;border-radius:5px;width:100px;height:200px;'>
							...
							<td width='500' valign='top' style='padding-left:300px;'>
								<table>
									<tr>
										<td valign='top'><center>
											<b>Creator:</b><br /><a href='/user.php?ID=".$gI->CreatorID."' border='0' style='color:black;'>
											";
										...
										<td align='left' valign='top'>
											<font color='green'><b>Bux: $".$gI->Price."</b></font> &nbsp; &nbsp; "; if ($gI->sell == "yes") { if ($Status->ItemStatus == 0) { echo "<button id='buttonsmall' value='".$ID."' name='Buy_item'>Buy Now</button> "; } else { echo "<font color='red'>Sorry, we are not allowing purchases at this time. Please try again later.</font>"; } }
											
											if ($gI->saletype == "limited") {
											
											echo "
											<br />
											<font color='red'><b>".$gI->numberstock." out of ".$gI->numbersales." instock</B></FONT>
											";
											}
											else {
											...
											echo "
											<br />
											<font color='purple'><b>".$gsold." sold</b></font>
											";
											...
											<b>Description:</b>
											<br />
											<div style='background:#f5f5f5;border-radius:5px;padding:3px;width:300px;font-size:10pt;padding-top:5px;padding-bottom:5px;max-height:70px;overflow-y:auto;height:100px;'>
												<i>".nl2br($gI->Description)."</i>
											</div>
											";
											if ($myU->PowerAdmin == "true"||$myU->PowerMegaModerator == "true"||$myU->PowerImageModerator == "true"||$gI->CreatorID == $myU->ID) {
											echo "<a href='ConfigureItem.php?ID=$ID' style='color:black;font-weight:bold;'>Edit Item</a>";
											}
											echo "
										</td>
										<td valign='top' align='left' width='300'>
											...
											//</div>
											//<div id='aB'>
											//<a href='ConfigureItem.php?ID=".$ID."' style='color:black;'><b>Configure Item</b></a>
											//</div>
											//";
											}
			...
			<tr>
				...
				<td valign='top'>
					...
					<div id='aB'>
						<table width='100%'>
							<tr>
								<td width='30%' width='50%'>
									<b>Private Sales Sold:</b>
								</td>
								<td>
									<b>".$gI->NumberSold."</b>
								</td>
				...
				";
											if ($gI->saletype == "limited" && $gI->numberstock == "0"&&$tG >= "1" && $myU->ID != $gC->ID) {
												...
												<div id='aB' style='padding-left:8px;'><div align='left'>
	...
	<table width='95%'>
		<tr>
			<td width='60%' valign='top'>
				...
				<div id='aB'><center><a name='Comments'></a>
					";
						...
						while ($gC = mysql_fetch_object($getComments)) {
							...
							echo "
							<table width='95%' style='background:#F2F2F2;border-radius:5px;border:1px solid #ccc;'>
								<tr>
