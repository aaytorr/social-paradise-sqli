<?php
	...
	If you forgot your password, please type in the username. It will send an email with the account registered on. If the email is fake/no email, we can not help you.
	<br />
    ...
    $header .= "From: Social-Paradise <help@social-paradise.net>\r\n"; 
    $header .= "Reply-To: Social-Paradise <help@social-paradise.net>\r\n"; 
    $header .= "Return-Path: Social-Paradise <help@social-paradise.net>\r\n"; 
    $header .= "Content-Type: text/plain\r\n";
	$body = "Hi there ".$gU->Username."! We have received a request to reset your password. Please click this link: ../ForgotPassword.php?code=".$gU->Hash." to reset your password. If you did not request to reset your password, please disregard this email.";
